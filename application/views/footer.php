        ...
        <div class="config-wrapper-inner">
            ...
            <div id="config-panel" class="config-panel">
                ...
                <ul id="color-options" class="list-unstyled list-inline">
                    <li class="default active" ><a data-style="<?php echo base_url() ?>assets/css/styles.css" data-logo="assets/images/logo.png" href="#"></a></li>
                    <li class="green"><a data-style="<?php echo base_url() ?>assets/css/styles-green.css" data-logo="assets/images/logo-green.png" href="#"></a></li>
                    <li class="purple"><a data-style="<?php echo base_url() ?>assets/css/styles-purple.css" data-logo="assets/images/logo-purple.png" href="#"></a></li>
                    <li class="red"><a data-style="<?php echo base_url() ?>assets/css/styles-red.css" data-logo="assets/images/logo-red.png" href="#"></a></li>
                </ul><!--//color-options-->
...
<!-- Mirrored from themes.3rdwavemedia.com/college-green/1.5.2/ by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Mar 2016 12:41:09 GMT -->
</html> 